...
public class NorthFragment extends Fragment {
    ...
    public void initRecycler(){
        ...
        while(nations==null){
            nations = DataUtils_world.getNationsByContinents("北美洲");
//            System.out.println("nations null");
        }
        LinearLayoutManager layoutManager = new LinearLayoutManager(NorthFragment.this.getContext());
