 ...
 */
public class AustrliaFragment extends Fragment {
    RecyclerView recycle;
    private String c_name = "大洋洲";

    public AustrliaFragment() {
    ...
    public void initRecycler(){
        ...
        while(nations==null){
            nations = DataUtils_world.getNationsByContinents(c_name);
//            System.out.println("nations null");
        }
        LinearLayoutManager layoutManager = new LinearLayoutManager(AustrliaFragment.this.getContext());
