...
public class SouthFragment extends Fragment {
    ...
    public void initRecycler(){
        ...
        while(nations==null){
            nations = DataUtils_world.getNationsByContinents("南美洲");
//            System.out.println("nations null");
        }
        LinearLayoutManager layoutManager = new LinearLayoutManager(SouthFragment.this.getContext());
